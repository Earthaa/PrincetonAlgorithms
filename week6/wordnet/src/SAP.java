...
public class SAP {
   ...
   {
	   BreadthFirstDirectedPaths bfsv = new BreadthFirstDirectedPaths(this.myGraph,v);
	   BreadthFirstDirectedPaths bfsw = new BreadthFirstDirectedPaths(this.myGraph,w);
	   int Shortestdis = Integer.MAX_VALUE;
	   for(int i=0;i < this.myGraph.V();i++)
	   {
